...
class WishListListPage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_wish_list_list_page)

        itemRecyclerView = findViewById(R.id.listforwish)
    ...
    private fun getItemData() {
        ...
        database.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Log.e("WishListListPage", "Failed to read data", error.toException())
            }
        })
    }
    ...
    private fun deleteWatch(watch: Watch) {
        watch.id?.let {
            database.child(it).removeValue().addOnSuccessListener {
                ...
                Log.e("WishListListPage", "Failed to delete item", it)
            }
        }
    }
}
